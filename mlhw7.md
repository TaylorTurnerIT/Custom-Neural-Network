...
1.  Consider the following formula: where $\hat{p}_i$ is the model's output for example $i$ and $p_i \in \{0, 1\}$ is the true label. In 2–3 sentences, explain what this formula computes.
